		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tablaparametrizable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tablaparametrizable-display": {
								"semanticObject": "tablaparametrizable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tablaparametrizable",
									"url": sap.ui.require.toUrl("tablaparametrizable")
								}
							}
						}
					}
