		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#escanerscaner-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"escanerscaner-display": {
								"semanticObject": "escanerscaner",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=escaner.scaner",
									"url": sap.ui.require.toUrl("escaner/scaner")
								}
							}
						}
					}
